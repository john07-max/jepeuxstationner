 ...
 if(command==='wait') {await ready();}
  ...
  try {
   ...
   if(command==='reset') {
    ...
    await c.query(`BEGIN;
      DROP TABLE IF EXISTS parking_facilities,local_source_registry,lyon_verified_spaces,lyon_street_inventory,imported_parking_rules, source_coverage,parking_rules,data_sources,parking_zones,cities,schema_migrations;
